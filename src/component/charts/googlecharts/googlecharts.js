...
import {GooglePieChart1,
        ...
        GoogleLineChart,
        GoogleComboChart,
        GoogleBarChart2, GoogleTreeChart} from "./googlechartsData";
            ...
            <Row>
              ...
              <Col sm="12" xl="6 box-col-12 xl-100">
                <Card>
                  ...
                  <CardBody className="chart-block" id="pie-chart2">
                        <GooglePieChart2/>
                  </CardBody>
                </Card>
              </Col>
              <Col sm="12" xl="6 box-col-12 xl-100">
                <Card>
                  ...
                  <CardBody className="chart-block" id="pie-chart3">
                        <GooglePieChart3/>
                  </CardBody>
                </Card>
              </Col>
              <Col sm="12" xl="6 box-col-12 xl-100">
                <Card>
                  ...
                  <CardBody className="chart-block" id="pie-chart4">
                    <GooglePieChart4/>
                  </CardBody>
                </Card>
              </Col>
