            ...
            <Card className="gradient-warning o-hidden">
              <CardBody className="b-r-4">
                <div className="media static-top-widget">
                  ...
                  <div className="media-body"><span className="m-0 text-white">Messages</span>
                    <h4 className="mb-0 counter text-white">893</h4><MessageCircle className="icon-bg"/>
                  </div>
                </div>
              </CardBody>
            </Card>
            ...
            <Card className="gradient-info o-hidden">
              <CardBody className="b-r-4">
                <div className="media static-top-widget">
                  ...
                  <div className="media-body"><span className="m-0 text-white">New User</span>
                    <h4 className="mb-0 counter text-white">45631</h4><UserPlus className="icon-bg" />
                  </div>
                </div>
              </CardBody>
            </Card>
                ...
                <div className="weather-widget-top">
                  <div className="media">
                    ...
                    <div className="media-body">
                      <div>
                        <h2>36°C</h2>
                        <div className="location"><i className="icon-location-pin"></i>
                          <h6> Steiglens</h6>
                        </div>
                      </div>
                    </div>
                  ...
                  <Table borderless>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div className="span badge badge-pill pill-badge-secondary">6523</div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div className="span badge badge-pill pill-badge-success">6523</div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="font-secondary">Cancle</td>
                        <td>
                          <div className="span badge badge-pill pill-badge-warning">6523</div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div className="span badge badge-pill pill-badge-primary">6523</div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="font-primary">Pending</td>
                        <td>
                          <div className="span badge badge-pill pill-badge-danger">6523</div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="font-secondary">Cancle</td>
                        <td>
                          <div className="span badge badge-pill pill-badge-info">6523</div>
                        </td>
                      </tr>
                    </tbody>
                  </Table>
                ...
                <Row>     
                  <Col md="4" sm="12">
                    <div className="browser-widget b-r-light">
                      <div className="media">
                        <div className="media-img"><img src={require("../../../assets/images/dashboard/pc.png")} alt=""/></div>
                        <div className="media-body align-self-center">
                          ...
                          <div>
                            <p>Month </p>
                            <h4><span className="counter">66</span>%</h4>
                          </div>
                          <div>
                            <p>Week </p>
                  ...
                  <Col md="4" sm="12">
                    <div className="browser-widget b-r-light">
                      <div className="media">
                        <div className="media-img"><img src={require("../../../assets/images/dashboard/tab.png")} alt=""/></div>
                        <div className="media-body align-self-center">
                          <div>
                            <p>Daily </p>
                            <h4><span className="counter">16</span>%</h4>
                          </div>
                          <div>
                            <p>Month </p>
                            <h4><span className="counter">26</span>%</h4>
                          </div>
                          <div>
                            <p>Week </p>
                  ...
                  <Col md="4" sm="12">
                    <div className="browser-widget hover">
                      <div className="media">
                        <div className="media-img"><img src={require("../../../assets/images/dashboard/mobile.png")} alt=""/></div>
                        <div className="media-body align-self-center">
                          <div>
                            <p>Daily </p>
              ...
              <Row>
                <Col sm="6" className="pr-0">
                  <div className="media border-after-xs">
                    ...
                    <div className="media-body">
                      <h4 className="mb-0">$<span className="counter">256</span></h4><span className="mb-1">-$265(36%)</span>
                    </div>
                  </div>
                </Col>
                <Col sm="6" className="pl-0">
                  <div className="media">
                    ...
                    <div className="media-body pl-2">
                      <h4 className="mb-0">$<span className="counter">6954</span></h4><span className="mb-1">+$369(15%)</span>
                    </div>
                  </div>
                </Col>
                <Col sm="6" className="pr-0">
                  <div className="media border-after-xs">
                    ...
                    <div className="media-body">
                      <h4 className="mb-0">$<span className="counter">2500</span></h4><span className="mb-1">+$69(65%)</span>
                    </div>
                  </div>
                </Col>
                <Col sm="6" className="pl-0">
                  <div className="media">
                    ...
                    <div className="media-body pl-2">
                      <h4 className="mb-0">$<span className="counter">963198</span></h4><span className="mb-1">+$3654(90%)          </span>
                    </div>
                  </div>
                </Col>
              </Row>
                ...
                <Row>
                  <Col xl="5 col-xs-12" md="6" sm="12" className="gradient-primary">
                    <div className="cal-info text-center">
                      <h2>24</h2>
                      <div className="d-inline-block mt-2"><span className="b-r-light pr-3">March</span><span className="pl-3">2021</span></div>
                    ...
                    <tbody>
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size"><img className="img-radius m-r-15 rounded-circle" src={require("../../../assets/images/user/4.jpg")} alt=""/>
                      ...
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size"><img className="img-radius m-r-15 rounded-circle" src={require("../../../assets/images/user/1.jpg")} alt=""/>
                            <div className="d-inline-block">
                      ...
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size"><img className="img-radius m-r-15 rounded-circle" src={require("../../../assets/images/user/5.jpg")} alt=""/>
                            <div className="d-inline-block">
                      ...
                      <tr>
                        <td className="bd-t-none u-s-tb">
                          <div className="align-middle image-sm-size"><img className="img-radius m-r-15 rounded-circle" src={require("../../../assets/images/user/7.jpg")} alt=""/>
                            <div className="d-inline-block">
              ...
              <CardBody className="contact-form">
                <Form className="theme-form">
                  ...
                  <div className="text-sm-right">
                    <button className="btn btn-pill btn-primary-gradien">SEND IT</button>
                  </div>
                </Form>
              </CardBody>
            </Card>
              ...
              <Card>
                ...
                <CardBody>
                  <ul className="crm-activity">
                    <li className="media"><span className="mr-3 font-primary">A</span>
                    ...
                    <li className="media"><span className="mr-3 font-secondary">H</span>
                      <div className="align-self-center media-body">
