...
import {apexchartswidgets1,
        ...
        apexchartswidgets8,
        apexchartswidgets9,
        apexchartswidgets10} from '../../general/dashboard/charts/apexchartsData'
                ...
                <Card>
                  <CardHeader>
                    <Row>
                      ...
                      <div className="col-3 text-right"><TrendingUp className="text-muted align-middle"/></div>
                    </Row>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    <Row>
                      ...
                      <div className="col-3 text-right"><ShoppingBag className="text-muted align-middle"/></div>
                    </Row>
                  </CardHeader>
                  <CardBody className="r-dount px-0">
                    <Apexcharts series={apexchartswidgets5.series} options={apexchartswidgets5.options} type="donut" width="330" />
                  </CardBody>
                </Card>
              </Col>
              ...
              <Col xl="3" lg="12 box-col-12 xl-100">
                <Row>
                  <Col lg="12 xl-50" md="6">
                    ...
                    <Apexcharts series={apexchartswidgets7.series} options={apexchartswidgets7.options} type="line" height="160" />
                  ...
                  <Col lg="12 xl-50" md="6">
                    <Card className="o-hidden small-chart">
                    <Apexcharts series={apexchartswidgets8.series} options={apexchartswidgets8.options} type="line" height="160" />
                      <CardBody className="px-0 p-t-0">
                        <div className="p-l-25">
            ...
            <Row>
                ...
                <Card>
                  <CardHeader>
                    <Row>
                      ...
                      <div className="col-3 text-right"><Navigation className="text-muted align-middle"/></div>
                    </Row>
                  </CardHeader>
              ...
              <Col xl="5" lg="12 box-col-12">
                <Card>
                  ...
                  <Apexcharts series={apexchartswidgets10.series} options={apexchartswidgets10.options} type="radialBar" height="300"/>
                  </CardBody>
                </Card>
              </Col>
            </Row>
