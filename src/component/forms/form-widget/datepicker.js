                      ...
                      <FormGroup className="form-row">
                        ...
                        <div className="col-xl-5 col-sm-9">
                          <div className="form-row min-date">
                            ...
                            <div className="col-md-12 mb-2">
                              <label className="col-sm-3 col-form-label text-right">Min</label>
                              <DatePicker className="form-control digits"
                                selected={startDate}
                                onChange={handleChange}
                                minDate={new Date()}
                            ...
                            <div className="col-md-12 mb-2">
                              <label className="col-sm-3 col-form-label text-right">Max</label>
                              <DatePicker className="form-control digits"
                                selected={startDate}
                                onChange={handleChange}
                                maxDate={new Date()}
                            ...
                            <div className="col-md-12 date-range">
                              <label className="col-sm-3 col-form-label text-right">Range</label>
                              <DatePicker className="form-control digits"
                                selected={startDate}
                                onChange={handleChange}
                                selectsStart
