            ...
            <Row>
              <Col sm="12">
                <Card>
                  ...
                  <CardFooter>
                    <Button color="primary btn-pill" className="mr-1">Submit</Button>
                ...
                <Card>
                  ...
                  <CardBody>
                    <Form className="theme-form">
                      ...
                      <FormGroup className="row">
                        <Label className="col-sm-3 col-form-label" htmlFor="inputPassword3">Birth Date</Label>
                        <Col sm="9">
                        <DatePicker
                            selected={startDate}
                      ...
                      <FormGroup className="row">
                        <Label className="col-sm-3 col-form-label" htmlFor="inputPassword3">Select  State</Label>
                        <Col sm="9">
                        <Typeahead
                      ...
                      <div className="form-group row mb-0">
                        <Label className="col-sm-3 col-form-Label pb-0 mt-2">Checkboxes</Label>
