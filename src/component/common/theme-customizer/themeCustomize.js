                        ...
                        <h6>Layout Type</h6>
                            <ul className="main-layout layout-grid">
                                <li className={`${layout_type === 'ltr' ? 'active' : ''}`} onClick={() => handleLayout('ltr')}>
                                    ...
                                    <div className="body">
                                        <ul>
                                            ...
                                            <li className="bg-light body"> <span className="badge badge-dark">LTR</span></li>
                                        </ul>
                                    </div>
                                </li>
                                <li className={`${layout_type === 'rtl' ? 'active' : ''}`} onClick={() => handleLayout('rtl')}>
                                    ...
                                    <div className="body">
                                        <ul>
                                            <li className="bg-light body"><span className="badge badge-dark">RTL</span></li>
                                            <li className="bg-dark sidebar"></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <div className="body">
                                    <ul>
                                        <li className="bg-dark sidebar"></li>
                                        <li className="bg-light body"> <span className="badge badge-dark">Box</span></li>
                                    </ul>
                                </div>
                                </li>
                            </ul>
                            ...
                            {/* <h6 className="">Sidebar Type</h6>
                                <ul className="sidebar-type layout-grid">
                                <li data-attr="vertical" className="vertical" onClick={(e) => handleSidebarType(e, 'vertical', '')}>
                                    <div className="header bg-light">
                                        <ul>
                                            <li></li>
                                            <li></li>
