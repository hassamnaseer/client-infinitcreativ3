...
const Bookmark = (props)  => {
    ...
    return (
        <Fragment>
            <li className="onhover-dropdown"><img className="img-fluid img-shadow-warning" src={require("../../../assets/images/dashboard/bookmark.png")} alt=""/>
                      ...
                      <div className="front">
                        <ul className="droplet-dropdown bookmark-dropdown">
                          <li className="gradient-primary text-center">
                            <h5 className="f-w-700">Bookmark</h5><span>Bookmark Icon With Grid</span>
                          </li>
                          {/* <li>
                            <Row>
                              <div className="col-4 text-center"><FileText/></div>
                              <div className="col-4 text-center"><Activity/></div>
                              <div className="col-4 text-center"><User/></div>
                              <div className="col-4 text-center"><Clipboard/></div>
                              <div className="col-4 text-center"><Anchor/></div>
                              <div className="col-4 text-center"><Settings/></div>
                            </Row>
                          </li> */}
                          ...
                          <li className="text-center">
                            <Button color="flip-btn" id="flip-btn" onClick={addnewbookmark}>Add New Bookmark</Button>
                          </li>
                        </ul>
                      </div>
                      <div className="back">
                        <ul>
                          ...
                          <li>
                            <Button color="flip-back"  className="d-block" id="flip-back" onClick={backtobookmark}>Back</Button>
                          </li>
                        </ul>
                      </div>
                    </div>
