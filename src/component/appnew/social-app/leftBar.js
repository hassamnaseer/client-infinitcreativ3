                                    ...
                                    <Collapse isOpen={isProfile}>
                                        <CardBody className="socialprofile filter-cards-view">
                                            ...
                                            <div className="social-btngroup d-flex">
                                                <Button color="primary text-center btn-pill" type="button">Likes</Button>
                                                <Button color="light text-center btn-pill" type="button">View</Button>
                                            </div>
                                        ...
                                        <CardBody className="social-status filter-cards-view">
                                            <Form>
                                                <FormGroup className="m-0">
                                                    <Input className="form-control-plaintext" type="search" placeholder="Search Contacts.." />
                                                </FormGroup>
                                            </Form>
                                            <Media>
