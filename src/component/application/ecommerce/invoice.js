...
import {Container,Row,Col,Card,CardBody,Table,Button,Media,Form} from 'reactstrap'
                ...
                <CardBody>
                    ...
                    <div>
                        ...
                        <Row>
                            ...
                            <Media>
                                <Media left>
                                    <Media className="media-object img-60" src={require("../../../assets/images/logo/logo.png")} alt=""/>
                                </Media>
                                <Media body className="m-l-20">
                                <h4 className="media-heading">Poco</h4>
                                <p>hello@Poco.in<br/><span className="digits">289-335-6503</span></p>
                                </Media>
                            </Media>
                            </Col>
                            <Col sm="6">
                            <div className="text-md-right">
                                ...
                                Payment Due: June <span className="digits">27, 2015</span></p>
                            </div>
                            </Col>
                        </Row>
                        </div>
                        ...
                        <Row>
                            ...
                            <div>
                                <p className="legal">
                                    <strong>Thank you for your business!</strong>  Payment is expected within 31 days; please process this invoice within that time. There will be a 5% interest charge per month on late invoices.</p>
                            </div>
                            </Col>
                            <Col md="4">
        ...
        return (
            <Fragment>
                ...
                <Col sm="12" className="text-center mb-5">
                    <ReactToPrint
                        trigger={() => <Button color="primary" className="mr-2">Print</Button>}
                        content={() => componentRef.current}
                    /> 
                    <Link to="/ecommerce-app/product"><Button  color="secondary" >Cancel</Button></Link>
                </Col>
            </Fragment>
        );
