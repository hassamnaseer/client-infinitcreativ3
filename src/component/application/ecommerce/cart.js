...
import {Container,Row,Col,Card,CardHeader,CardBody,Table,Button,Input,InputGroup,InputGroupAddon} from 'reactstrap'
                ...
                <div className="order-history table-responsive wishlist">
                  <Table borderless>
                    ...
                    <tbody>
                                    ...
                                    <td>
                                        <div className="qty-box">
                                            <InputGroup>
                                                ...
                                                <Input type="text" name="quantity" value={item.qty} readOnly={true} style={{textAlign:"center",backgroundColor:"white"}} className="form-control input-number" />
                        ...
                        <tr>
                            <td colSpan="5">
                                <Link to="/ecommerce-app/product"><Button color="primary">continue shopping</Button></Link>
                            </td>
                            <td>
                                <Link to="/ecommerce-app/checkout"><Button color="primary">check out</Button></Link>
                            </td>
                        </tr>
                    </tbody>
                  </Table>
