...
export const  DefaultStep = (props) =>  {
    return (
            <Row className="u-steps row">
              <Col xl="4" lg="12" md="4" className="u-step xl-100"><span className="u-step-number">1</span>
                <div className="u-step-desc"><span className="u-step-title">Shopping</span>
                  <p>Choose what you want</p>
                </div>
              </Col>
              <Col xl="4" lg="12" md="4" className="u-step current xl-100"><span className="u-step-number">2</span>
                <div className="u-step-desc"><span className="u-step-title">Billing</span>
                  <p>Pay for the bill</p>
                </div>
              </Col>
              <Col xl="4" lg="12" md="4" className="u-step xl-100"><span className="u-step-number">3</span>
