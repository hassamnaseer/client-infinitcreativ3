...
export const SubNavToggle = (props) => {
    ...
    return (
        <Fragment>
        <li>
        <Button className="btn btn-link text-muted active" color="default" id="advance" onClick={Advance} aria-expanded={expanded1}><FolderPlus/><span> Advance</span></Button>
        <Collapse
         isOpen={isOpen1}
         target="advance"
        >
        ...
        <li>
        <Button className="btn btn-link text-muted active" color="default" id="tables" onClick={Tables} aria-expanded={expanded2}><Server/> Tables</Button>
        <Collapse
         isOpen={isOpen2}
         target="tabels"
        > 
