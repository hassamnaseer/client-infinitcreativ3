            ...
            <Card>
              ...
              <CardBody>
                ...
                <div className="onhover-dropdown navs-dropdown">
                  <Button  color="primary" className="onhover-dropdown">Dropdown example <i className="icon-arrow-down align-middle"></i></Button>
                ...
                <Row>
                    ...
                    <ul className="icon-lists border navs-icon">
                      ...
                      <li><a href="#javascript"><FolderPlus/><span>Advance</span></a>
                        <ul>
                          <li className="pl-navs-inline"><a href="#javascript"><i className="fa fa-angle-right"></i><span>Scrollable</span></a></li>
                          <li className="pl-navs-inline"><a href="#javascript"><i className="fa fa-angle-right"></i><span>Tree View</span></a></li>
                          <li className="pl-navs-inline"><a href="#javascript"><i className="fa fa-angle-right"></i><span>Rating</span></a></li>
                        </ul>
                      </li>
                      <li><a href="#javascript"><FileText/><span> Forms</span></a></li>
                      <li><a href="#javascript"><Server/><span> Tables</span></a></li>
