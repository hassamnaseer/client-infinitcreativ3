        ...
        <Container fluid={true}>
            <Row>
              <Col  sm="12" xl="6 xl-100">
                <Card>
                  <CardHeader>
                    <h5>Simple Material style tab</h5><span>Add <code>.border-tab-primary</code> class with nav class</span>
                  </CardHeader>
                  <CardBody>
              ...
              <Col  sm="12" xl="6 xl-100">
                <Card>
                  <CardHeader>
                    <h5>Material style bottom tab</h5><span>Add <code>.border-tab-primary</code> class with nav class</span>
                  </CardHeader>
                  <CardBody>
              ...
              <Col  sm="12" xl="6 xl-100">
                <Card>
                  <CardHeader>
                    <h5>Material style left tab</h5><span>Add <code>.border-tab-primary</code> class with nav class</span>
                  </CardHeader>
                  <CardBody>
                    <Row>
              ...
              <Col  sm="12" xl="6 xl-100">
                <Card>
                  <CardHeader>
                    <h5>Material style right tab</h5><span>Add <code>.border-tab-primary</code> class with nav class</span>
                  </CardHeader>
                  <CardBody>
                    <Row>
                       <Col sm="9">
