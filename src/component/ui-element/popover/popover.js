...
import { Container,Row,Col,Card,CardBody,CardHeader,Button,Popover,PopoverHeader,PopoverBody} from 'reactstrap';
import {MultiPopoverDirection,MultiPopoverHtmlContent,MultiPopoverOffset} from './popovercomponent'
              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody className="btn-showcase">
                    <Button color="primary" className="example-popover" id={"Popover-" + 1}> Click to toggle popover</Button>
                    <Popover
                        placement="right"
                        isOpen={popover}
                        target={"Popover-" + 1}
                    ...
                    <Button className="example-popover"  color="primary" id={"Popover-" + 2}>Dismissible popover</Button>
                    <Popover
                        placement="right"
                        isOpen={popover2}
                        target={"Popover-" + 2}
                    ...
                    <Button className="example-popover"  color="primary" id={"Popover-" + 3}>On Hover Tooltip</Button>
                    <Popover
                        placement="right"
                        isOpen={popover3}
                        target={"Popover-" + 3}
